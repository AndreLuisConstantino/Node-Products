...
const ERROR_MISTAKE_IN_THE_FILDS = {
  status: 400,
  message: "Campos obrigatórios foram preenchidos errado.",
};

const ERROR_INTERNAL_SERVER = {
  status: 500,
  message:
    "Devido a um erro interno no servidor não possivel processar a requisição.",
};

const ERROR_INVALID_CONTENT_TYPE = {
  status: 415,
  message: `O tipo de mídia no tipo de conteúdo da solicitação não é suportado pelo servidor. [application/json]`,
};
...
const ERROR_DELETED_ITEM = {
  status: 404,
  message: "O item não pode ser excluido, pois ele não foi encontrado",
};

const ERROR_ITEM_NOT_FOUND = {
  status: 404,
  message: "O item não pode ser encontrado na requisição.",
};
